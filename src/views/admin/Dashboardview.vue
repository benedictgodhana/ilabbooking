<template>
    ...
    <v-list-item
      ...
      <v-row justify="center">
        <!-- User Card -->
        <v-col cols="12" md="4">
          <v-card class="pa-8" color="primary" elevation="4" style="border-radius:10px">
            <v-row align="center">
              <v-col cols="3">
                <v-icon size="48" color="white">mdi-account-multiple</v-icon>
              </v-col>
              <v-col cols="9">
                <div class="headline white--text">{{ totalUsers }}</div>
                <div class="caption white--text">Total Users</div>
              </v-col>
            </v-row>
          </v-card>
        </v-col>
        ...
        <!-- Booking Card -->
        <v-col cols="12" md="4">
          <v-card class="pa-8" color="secondary" elevation="4" style="border-radius:10px">
            <v-row align="center">
              <v-col cols="3">
                <v-icon size="48" color="white">mdi-calendar-clock</v-icon>
              </v-col>
              <v-col cols="9">
                <div class="headline white--text">{{ totalBookings }}</div>
                <div class="caption white--text">Total Bookings</div>
              </v-col>
            </v-row>
          </v-card>
        </v-col>
        ...
        <!-- Room Card -->
        <v-col cols="12" md="4">
          <v-card class="pa-8" color="success" elevation="4" style="border-radius:10px">
            <v-row align="center">
              <v-col cols="3">
                <v-icon size="48" color="white">mdi-door</v-icon>
              </v-col>
              <v-col cols="9">
                <div class="headline white--text">{{ totalRooms }}</div>
                <div class="caption white--text">Total Rooms</div>
              </v-col>
            </v-row>
          </v-card>
        </v-col>
